...
return [
    ...
    'contact_notification' => [
        ...
        'name' => env('MAIL_CONTACT_TO_NAME', env('MAIL_FROM_NAME', 'Admin')),
    ],

    'careers_notification' => [
        'address' => env('MAIL_CAREERS_TO_ADDRESS', env('MAIL_FROM_ADDRESS', 'hello@example.com')),
        'name' => env('MAIL_CAREERS_TO_NAME', env('MAIL_FROM_NAME', 'Admin')),
    ],
];
